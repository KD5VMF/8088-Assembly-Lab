...
setlocal
cd /d "%~dp0"
echo Building SerialMatrixCoproc x86 using MSBuild and .NET Framework project...
where msbuild >nul 2>nul
if errorlevel 1 goto no_msbuild
msbuild SerialMatrixCoproc.Framework.csproj /p:Configuration=Release /p:Platform=x86
if errorlevel 1 goto fail
copy /Y "bin\x86\Release\SerialMatrixCoproc.exe" . >nul
